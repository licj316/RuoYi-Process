...
package com.ruoyi.process.core.plugin.flowable.elbeans.multiinstance;
...
public class MultiInstanceCompleteTask implements Serializable, IocElBeans {
    ...
    public MultiInstanceCompleteTask() {
    }


    public FlowProcessDefinitionService flowProcessDefinitionService() {
        return SpringUtils.getBean(FlowProcessDefinitionService.class);
    }
