...
import com.ruoyi.process.core.plugin.flowable.delegate.CustomClassDelegate;
...
public class CustomClassDelegateFactory extends DefaultClassDelegateFactory {
    ...
    public CustomClassDelegateFactory() {
    }
    ...
    public ClassDelegate create(String id, String className, List<FieldDeclaration> fieldDeclarations,
        ...
        return new CustomClassDelegate(id, className, fieldDeclarations, triggerable, skipExpression, mapExceptions);
    }

    @Override
    public ClassDelegate create(String className, List<FieldDeclaration> fieldDeclarations) {
        return new CustomClassDelegate(className, fieldDeclarations);
    }
}
